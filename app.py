...
def write_csv(csv_file, items):
    with open(csv_file, 'w', newline='') as file:
        fieldnames = ['name', 'availability', 'location', 'usage']
...
def add_item():
    ...
    if not item_exists:
        items.append({'name': name, 'availability': str(availability), 'location': location, 'usage': usage})
